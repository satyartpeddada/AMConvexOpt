...
% CASE STUDY-01 OBJECTIVE FUNCTION
%--------------------------------------------------------------------------
% objfn.m
% 
%--------------------------------------------------------------------------
% This function contains the defintion of the objective function for Case
% Study 1 without machine cell disruption.
%--------------------------------------------------------------------------
...
t10 = 31;
t11 = 1.667; 
% sum(t1+t2+t3+t4+t5+t6+t7+t8+t9+t10+t11)
...
% Objective Function F = Tcell + Pcell
o1 = t1 + t2 + t3 + t4 + t5 + t6 + t7 + t8 + t9 + t10 + t11;
o2 = p1 + p2 + p3 + p4 + p5 + p6 + p7 + p8 + p9 + p10 + p11;
F = w*(o1)+ (1-w)*o2;
% counter
